...
decode' 0x08 = pushPop Push StackArgP -- PHP
...
decode' 0x28 = pushPop Pop StackArgP -- PLP
...
decode' 0x48 = pushPop Push StackArgA -- PHA
...
decode' 0x68 = pushPop Pop StackArgA -- PLA
...
decode' 0x96 = stx AddrZP OffsetPreAddX -- STX
...
decode' 0xA4 = ldy AddrZP OffsetNone -- STY
...
decode' 0xE1 = bin AddrIndirect OffsetPostAddY SBC -- SBC
...
decode' 0xED = bin AddrDirect OffsetPreAddX SBC -- SBC
decode' 0xEE = un AddrDirect OffsetPreAddX INC -- INC
...
pushPop pp arg = return (AddrNone, (OffsetNone, (Nothing, (False, (Nothing, (False, (OpPushPop pp arg, False)))))))
